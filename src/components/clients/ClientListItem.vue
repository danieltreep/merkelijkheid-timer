...
import ArchiveClientButton from "@/components/clients/ArchiveClientButton.vue";
import ColorSelector from '@/components/ColorSelector.vue';
import AddProjectButton from '@/components/projects/AddProjectButton.vue';
...
const filterProjectsByClient = computed(() => projects.value.filter(project => project.client_id === client.value.client_id))
